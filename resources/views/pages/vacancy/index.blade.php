                                ...
                                <tbody>
                                    @foreach ($allVacancies as $vacancy)
                                        <tr>
                                            ...
                                            <td>
                                                {{-- <a href="#" class="btn btn-primary btn-circle"><i
                                                        class="bi bi-pencil-square"></i></a> --}}
                                                <button type="button" class="btn btn-primary btn-circle"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#modalEdit_{{ $vacancy->id }}">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                                <a href="#" class="btn btn-danger btn-circle btn-hapusJur"><i
                                        ...
                                        <x-modal title="Edit Data Lowongan" idModal="modalEdit_{{ $vacancy->id }}">
